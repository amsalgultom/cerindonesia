    ...
    <div class="swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="#">
                    <div class="relative h-full bg-primary-900">
                        <img alt="" class="absolute inset-0 w-full h-full object-cover" src="{{ asset('images/Announce_Rev3-scaled.jpg') }}">
                        <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-t from-black/50 to-black/20 text-white">
                            <h1 class="px-12 text-3xl font-bold md:px-20 md:text-4xl md:leading-tight lg:px-40 xl:px-80"></h1>
                        </div>
                    </div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="#">
                    <div class="relative h-full bg-primary-900">
                        <img alt="" class="absolute inset-0 w-full h-full object-cover" src="{{ asset('images/Anniversary-Banner_Final-1.png') }}">
                        <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-t from-black/50 to-black/20 text-white">
                            <h1 class="px-12 text-3xl font-bold md:px-20 md:text-4xl md:leading-tight lg:px-40 xl:px-80"></h1>
                        </div>
                    </div>
                ...
                <section class="mt-8 grid grid-cols-1 gap-x-12 gap-y-8 md:grid-cols-2">
                    <div class="group flex gap-4">
                        <div class="relative mt-1.5 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded bg-primary-600/40 p-2.5 shadow-lg shadow-primary-900/20 duration-200 group-hover:bg-primary-500/50 group-hover:shadow-primary-900/10 md:h-16 md:w-16 md:p-4">
                            <img alt="service icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('images/cloud.png') }}"><span class="absolute -right-1 -top-1 hidden h-1/3 w-1/3 rounded-full bg-primary-400 opacity-50 group-hover:inline-flex group-hover:animate-ping"></span>
                        </div>
                        <div class="">
                            ...
                            <ul class="ml-6">
                                ...
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Disclosure</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Decarbonization Strategy</li>
                            </ul>
                        </div>
                    </div>
                    <div class="group flex gap-4">
                        <div class="relative mt-1.5 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded bg-primary-600/40 p-2.5 shadow-lg shadow-primary-900/20 duration-200 group-hover:bg-primary-500/50 group-hover:shadow-primary-900/10 md:h-16 md:w-16 md:p-4">
                            <img alt="service icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('images/IMG-20230807-WA0000-removebg-preview-02-removebg-preview.png') }}"><span class="absolute -right-1 -top-1 hidden h-1/3 w-1/3 rounded-full bg-primary-400 opacity-50 group-hover:inline-flex group-hover:animate-ping"></span>
                        </div>
                        <div class="">
                            ...
                            <ul class="ml-6">
                                ...
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    GHG Inventory</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Climate Adaption Resilience</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Mitigation Plan</li>
                            </ul>
                        </div>
                    ...
                    <div class="group flex gap-4">
                        <div class="relative mt-1.5 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded bg-primary-600/40 p-2.5 shadow-lg shadow-primary-900/20 duration-200 group-hover:bg-primary-500/50 group-hover:shadow-primary-900/10 md:h-16 md:w-16 md:p-4">
                            <img alt="service icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('images/leaf.png') }}"><span class="absolute -right-1 -top-1 hidden h-1/3 w-1/3 rounded-full bg-primary-400 opacity-50 group-hover:inline-flex group-hover:animate-ping"></span>
                        </div>
                        <div class="">
                            ...
                            <ul class="ml-6">
                                ...
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    ESG</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Climate Finance Evaluation</li>
                            </ul>
                        </div>
                    </div>
                    <div class="group flex gap-4">
                        <div class="relative mt-1.5 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded bg-primary-600/40 p-2.5 shadow-lg shadow-primary-900/20 duration-200 group-hover:bg-primary-500/50 group-hover:shadow-primary-900/10 md:h-16 md:w-16 md:p-4">
                            <img alt="service icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('images/Carbon-Trading-1.png') }}"><span class="absolute -right-1 -top-1 hidden h-1/3 w-1/3 rounded-full bg-primary-400 opacity-50 group-hover:inline-flex group-hover:animate-ping"></span>
                        </div>
                        <div class="">
                            <h3 class="text-lg font-semibold text-dark-800">Carbon Trading</h3>
                            <ul class="ml-6">
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Voluntary Carbon Market</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Domestic Carbon Market</li>
                            </ul>
                        </div>
                    </div>
                    <div class="group flex gap-4">
                        <div class="relative mt-1.5 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded bg-primary-600/40 p-2.5 shadow-lg shadow-primary-900/20 duration-200 group-hover:bg-primary-500/50 group-hover:shadow-primary-900/10 md:h-16 md:w-16 md:p-4">
                            <img alt="service icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" style="color:transparent" src="{{ asset('images/Capacity-Building-1.png') }}"><span class="absolute -right-1 -top-1 hidden h-1/3 w-1/3 rounded-full bg-primary-400 opacity-50 group-hover:inline-flex group-hover:animate-ping"></span>
                        </div>
                        <div class="">
                            <h3 class="text-lg font-semibold text-dark-800">Capacity development</h3>
                            <ul class="ml-6">
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Carbon Project Mechanism</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Carbon Accounting</li>
                                <li class="list-outside list-image-[url(&#39;data:image/svg+xml;base64,&#39;)] text-dark-700">
                                    Mitigation and Adaptation Action</li>
                            </ul>
                        </div>
                    </div>
                </section>
